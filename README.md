...
Then start the teacher app in a second terminal:
...
sample teacher, class, student, timetable record, and roll entry. Existing
databases are migrated automatically so students can exist before a card is
assigned.
...
teacher, class, student, NFC-linking, connected-reader, and attendance workflow.
